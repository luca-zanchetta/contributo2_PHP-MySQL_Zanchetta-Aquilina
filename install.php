...
Alla fine del corso lo studente sarà in grado di interagire con il destinatario di un\'applicazione di basi di dati in modo da sintetizzare correttamente i requisiti e di sviluppare prima il progetto, poi l\'applicazione stessa, scegliendo gli strumenti più idonei.', 'Umberto Nanni', 'lightblue','Terzo','Primo','Informatica', 9, 'ING/INF-04'),
...
Alla fine del corso lo studente sarà in grado di utilizzare in modo consapevole il sistema di elaborazione, sfruttando al meglio le risorse a sua disposizione, sapendo individuare ed eventualmente risolvere i colli di bottiglia che limitano le prestazioni.', 'Christian Napoli', 'lightpurple','Terzo','Primo','Informatica', 9, 'ING/INF-04'),
...
Al termine del corso lo studente avrà acquisito: le competenze di base per lo sviluppo di progetti software anche complessi, familiarità con i principi di base della programmazione orientata agli oggetti, conoscenza del linguaggio Java e di avanzati ambienti di sviluppo.', 'Irene Amerini', 'turquoise','Secondo','Primo','Informatica', 9, 'ING/INF-04'),
